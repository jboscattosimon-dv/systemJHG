...
-- ================================================================
-- Precisamos saber de quem é cada venda pra Dashboard e relatórios
-- poderem restringir a visão do atendente só ao que ele mesmo fez
-- (mesmo espírito de condicionais.usuario_id, já existente).
-- fechar_condicional chama finalizar_venda por baixo, então esse
-- único ajuste cobre venda direta e venda originada de condicional.
--
-- Coluna precisa existir antes de recriar a função que agora
-- escreve nela.
