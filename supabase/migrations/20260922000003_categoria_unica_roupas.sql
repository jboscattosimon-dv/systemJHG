-- ================================================================
--  Categoria de produto vira só "roupas"
-- ================================================================
-- As categorias antigas (bebidas/pomadas/petiscos/outros) vieram do
-- Barber (barbearia) e não fazem sentido pra uma loja de roupas. Loja
-- só vende roupa, então a categoria deixa de ser uma escolha na tela
...
-- importar_produtos criava produto novo com categoria fixa 'outros'.
...
-- registrar_entrada_produtos: categoria de item novo cai pra 'roupas'
-- (a tela nem manda mais esse campo). Mesma assinatura de parâmetros
-- e mesmas colunas de retorno — CREATE OR REPLACE cobre a troca.
