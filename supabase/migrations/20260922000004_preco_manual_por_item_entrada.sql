-- ================================================================
--  Entrada de mercadoria — preço de venda manual por item
-- ================================================================
-- Cada item pode vir com "preco_venda" e/ou "preco_venda_prazo"
-- definidos manualmente. Quando vem, usa direto no lugar do cálculo
-- por margem (a margem continua valendo pros itens que não informarem
-- preço). O custo unitário (rateio de frete/despesa) é calculado do
-- mesmo jeito de sempre, independente do preço ser manual ou
-- automático — isso é só sobre o preço de venda.
--
